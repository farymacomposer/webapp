...
#pragma warning disable 612, 618
            ...
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "app", "transaction_type", new[] { "unspecified", "deposit", "payment" });
            ...
            modelBuilder.Entity("Faryma.Composer.Contracts.Infrastructure.Entities.ReviewOrderEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Faryma.Composer.Contracts.Infrastructure.Entities.TransactionEntity", b =>
                {
                    ...
                    b.Property<TransactionType>("Type")
                        .HasColumnType("app.transaction_type");
            ...
            modelBuilder.Entity("Faryma.Composer.Contracts.Infrastructure.Entities.ReviewEntity", b =>
                {
                    b.HasOne("Faryma.Composer.Contracts.Infrastructure.Entities.ReviewOrderEntity", "ReviewOrder")
                        .WithOne("Review")
            ...
            modelBuilder.Entity("ReviewOrderEntityUserNicknameEntity", b =>
                {
                    b.HasOne("Faryma.Composer.Contracts.Infrastructure.Entities.ReviewOrderEntity", null)
                        .WithMany()
