    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.AlterDatabase()
                ...
                .Annotation("Npgsql:Enum:app.UserEntitlementTarget", "unspecified,out_of_queue_review_order,free_review_order,detailed_review");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReviewOrderNominalPrice = table.Column<long>(type: "bigint", nullable: false),
                    IncludedTrackDurationSeconds = table.Column<int>(type: "integer", nullable: false),
                    ReviewOrderExtraTrackSecondPrice = table.Column<long>(type: "bigint", nullable: false),
                    ReviewOrderDetailedPrice = table.Column<long>(type: "bigint", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    EndpointKey = table.Column<string>(type: "character varying(300)", maxLength: 300, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_idempotency_records_EndpointKey_UserId_IdempotencyKey",
                schema: "app",
                table: "idempotency_records",
                columns: new[] { "EndpointKey", "UserId", "IdempotencyKey" },
                unique: true);
