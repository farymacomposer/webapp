    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.AlterDatabase()
                ...
                .Annotation("Npgsql:Enum:app.transaction_type", "unspecified,deposit,payment");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TrackCountries", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Tracks_TrackCountries_CountryId",
                        column: x => x.CountryId,
                        principalSchema: "app",
                        principalTable: "TrackCountries",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Tracks_UserNicknames_AddedByUserNicknameId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    Type = table.Column<TransactionType>(type: "app.transaction_type", nullable: false),
